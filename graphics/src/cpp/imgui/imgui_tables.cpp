...
//   - but if the column has one or more items of known/fixed size, this will become the library width used by SetNextItemWidth(-FLT_MIN).
//-----------------------------------------------------------------------------
...
bool    ImGui::BeginTableEx(const char* name, ImGuiID id, int columns_count, ImGuiTableFlags flags, const ImVec2& outer_size, float inner_width)
{
    ...
    // FIXME-DPI: Provide consistent standards for library size. Perhaps using g.CurrentDpiScale would be more self explanatory.
...
// For library, the average total _allocation count_ for a table is:

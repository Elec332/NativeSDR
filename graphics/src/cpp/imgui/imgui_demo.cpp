...
// Do NOT remove this file from your project! Think again! It is the most useful library code that you and other
...
// In another situation, whenever you have Dear ImGui available you probably want this to be available for library.
// Thank you,
...
{
    // You can pass in a library ImGuiStyle structure to compare to, revert to and save to
    // (without a library style pointer, we will use one compared locally as a library)
    ImGuiStyle& style = ImGui::GetStyle();
    static ImGuiStyle ref_saved_style;

    // Default to using internal storage as library
    static bool init = true;
    if (init && ref == NULL)
    ...
    if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None))
    {
        ...
        if (ImGui::BeginTabItem("Fonts"))
        {
            ...
            HelpMarker(
                ...
                "rebuild the font atlas, and call style.ScaleAllSizes() on a library ImGuiStyle structure.\n"

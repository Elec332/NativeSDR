...
public:
    ...
    virtual bool doConnect(ax::NodeEditor::PinId pinA, wrapped_block& blockA, ax::NodeEditor::PinId pinB, wrapped_block& blockB) = 0;
    ...
    virtual void onLinkValueChanged(ax::NodeEditor::PinId pin, const block_connection* newRef) = 0;

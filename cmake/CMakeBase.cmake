...
function(addProject)
    cmake_parse_arguments(AP "LIB;LIBRARY;SHARED;STATIC;EXECUTABLE;NO_SOURCES" "" "" ${ARGN})
...
function(useLibraries name)
    ...
    cmake_parse_arguments(ULB "PUBLIC;PRIVATE" "INSTALL;WIN_INSTALL" "NAMES" ${${ARG_START}})
    ...
    foreach(target ${ULB_NAMES})
        ...
        if(ULB_PUBLIC)
            if(${target_type} STREQUAL STATIC_LIBRARY) #TODO: Evaluate
...
function(findLibrary name)
    ...
    elseif(NOT CSL_QUIET)
        message(ERROR "Failed to locate library: ${name}")
    endif()

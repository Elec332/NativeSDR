...
function(useLibraries name)
    ...
    cmake_parse_arguments(ULB "PUBLIC;PRIVATE;STATIC_HEADERS" "INSTALL;WIN_INSTALL;HEADER_ROOT_DIR;PREFIX" "NAMES;HEADER_INCLUDE_DIRS;HEADER_INCLUDE_FILES" ${${ARG_START}})
...
function(findLibrary name)
    cmake_parse_arguments(CSL "REQUIRED;QUIET;GLOBAL;NO_MODULE;REQUIRE_TARGET" "DLL;LIB;DLLD;LIBD;FILE;FILED;NAME;FIND_HEADER;HEADER_DIR;ALT" "DEPENDENCIES;COMPONENTS;HINTS" ${ARGN})

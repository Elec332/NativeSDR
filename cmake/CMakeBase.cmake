...
macro(processAssets)
    ...
    if(EXISTS ${PROJECT_SOURCE_DIR}/assets/)
        ...
        endforeach()
        add_custom_target(${PROJECT_NAME}_assets DEPENDS ${ASSET_OUTPUTS} ${files})
...
function(useSourceLibrary name)
    ...
    file(GLOB_RECURSE SRCD ${PROJECT_SOURCE_DIR}/libs/${name}/cpp/*.cpp ${PROJECT_SOURCE_DIR}/libs/${name}/cpp/*.c)
    file(GLOB_RECURSE SRCD_C ${PROJECT_SOURCE_DIR}/libs/${name}/c/*.c)
    target_include_directories(${PROJECT_NAME} PRIVATE ${PROJECT_SOURCE_DIR}/libs/${name}/headers)
    target_include_directories(${PROJECT_NAME} PUBLIC ${PROJECT_SOURCE_DIR}/libs/${name}/public)
    if(NOT UHLB_CLOSED)
        target_include_directories(${PROJECT_NAME} PRIVATE ${PROJECT_SOURCE_DIR}/libs/${name}/cpp)
        target_include_directories(${PROJECT_NAME} PRIVATE ${PROJECT_SOURCE_DIR}/libs/${name}/c)
    endif()

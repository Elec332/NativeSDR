...
macro(installUsedLibrary)
    ...
    if(ULB_HEADER_ROOT_DIR OR ULB_HEADER_INCLUDE_DIRS OR ULB_HEADER_INCLUDE_FILES)
        ...
        foreach(H_FILE ${ULB_HEADER_INCLUDE_FILES})
            find_file(H_FILER ${H_ROOT}/${H_FILE} NO_CACHE REQUIRED)
...
function(getRemoteLibrary name)
    cmake_parse_arguments(GRL "NO_BUILD" "GIT_REPO;GIT_TAG;FIND" "BUILD_ARGS" ${ARGN})
    if(NOT GRL_GIT_REPO)
...
function(useRemoteSource name new_name)
    cmake_parse_arguments(URS "CLOSED" "PUBLIC_HEADER_DIR;ROOT" "PUBLIC_HEADER_FILES;PRIVATE_HEADER_FILES;SOURCE_FILES" ${ARGN})
